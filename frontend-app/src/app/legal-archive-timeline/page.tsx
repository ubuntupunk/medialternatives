          ...
          <div className="timeline-phases mb-5">
            ...
            <div className="row g-0">
              <div className="col-2">
                <a 
                  href="#phase1-2006"
                  className="phase-card bg-danger text-white text-center p-3 h-100 d-flex flex-column justify-content-center text-decoration-none"
                  style={{ display: 'block' }}
                >
              ...
              <div className="col-2">
                <a 
                  href="#phase2-2009-2010"
                  className="phase-card bg-warning text-dark text-center p-3 h-100 d-flex flex-column justify-content-center text-decoration-none"
                  style={{ display: 'block' }}
                >
              ...
              <div className="col-2">
                <a 
                  href="#phase3-2011-2014"
                  className="phase-card bg-info text-white text-center p-3 h-100 d-flex flex-column justify-content-center text-decoration-none"
                  style={{ display: 'block' }}
                >
              ...
              <div className="col-2">
                <a 
                  href="#phase4-2014-2015"
                  className="phase-card bg-primary text-white text-center p-3 h-100 d-flex flex-column justify-content-center text-decoration-none"
                  style={{ display: 'block' }}
                >
              ...
              <div className="col-2">
                <a 
                  href="#phase5-2016-2018"
                  className="phase-card bg-secondary text-white text-center p-3 h-100 d-flex flex-column justify-content-center text-decoration-none"
                  style={{ display: 'block' }}
                >
              ...
              <div className="col-2">
                <a 
                  href="#phase6-2019-2024"
                  className="phase-card bg-success text-white text-center p-3 h-100 d-flex flex-column justify-content-center text-decoration-none"
                  style={{ display: 'block' }}
                >
            ...
            <div className="text-center mt-2">
              <small className="text-muted">
                ...
                Click any phase to jump to details - 18-year legal saga across multiple courts
              </small>
            </div>
          </div>
          ...
          <div className="legal-timeline-content">
            <ReactMarkdown
              components={{
                ...
                h2: ({ ...props }) => {
                  // Add IDs for phase sections
                  const text = props.children?.toString() || '';
                  let id = '';
                  if (text.includes('2006')) id = 'phase1-2006';
                  else if (text.includes('2009-2010')) id = 'phase2-2009-2010';
                  else if (text.includes('2011')) id = 'phase3-2011-2014';
                  else if (text.includes('2014-2015')) id = 'phase4-2014-2015';
                  else if (text.includes('2016-2018')) id = 'phase5-2016-2018';
                  else if (text.includes('2019-2024')) id = 'phase6-2019-2024';
                  
                  return <h2 id={id} className="h3 mt-5 mb-3 text-primary scroll-mt-5" {...props} />;
                },
                ...
                hr: ({ ...props }) => <hr className="my-5 border-2 border-primary" {...props} />,
              }}
            >
              {markdownContent}
            </ReactMarkdown>
