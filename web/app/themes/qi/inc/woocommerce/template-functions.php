...
if ( ! function_exists( 'qi_add_main_woo_page_template_holder' ) ) {
	...
	function qi_add_main_woo_page_template_holder() {
		echo '<main id="qodef-page-content" class="qodef-grid qodef-layout--template qodef--no-bottom-space ' . esc_attr( qi_get_grid_gutter_classes() ) . '"><div class="qodef-grid-inner clear">';
	}
}
